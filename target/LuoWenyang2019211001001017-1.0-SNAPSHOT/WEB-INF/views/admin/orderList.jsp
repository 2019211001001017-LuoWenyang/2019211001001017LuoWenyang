			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.LuoWenyang.model.Order o=(com.LuoWenyang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LuoWenyang.dao.UserDao userDao=new com.LuoWenyang.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LuoWenyang.model.Payment.findByPaymentId(con,n);
							 %>
