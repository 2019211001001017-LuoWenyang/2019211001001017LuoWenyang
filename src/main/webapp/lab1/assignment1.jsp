<%@ page import="com.LuoWenyang.lab1.Person" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="java.util.List" %>
<%@ page import="com.LuoWenyang.lab1.Dog" %><%--
...
<%--todo 8 : use c:forToken to print all words --%>
    <ul>
        <c:forTokens  var="words" items= "${str}" delims=":">
            <c:forTokens  var="words" items= "${words}" delims="-">
                <li>${words}</li>
            </c:forTokens>
        </c:forTokens>
    </ul>
